...
```
## deploy-netlify — [current date and time]
**Status:** ✅ Live | ❌ Failed

**Site name:** [name used]
**Site URL:** [https://... or "not obtained"]
**Build command detected:** [command or "none"]
**Publish directory detected:** [dir or "none"]
**Env vars injected:** [list of variable NAMES set — no values]
**Deploy time:** [~N seconds/minutes]
