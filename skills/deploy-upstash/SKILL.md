...
```
## deploy-upstash — [current date and time]
**Status:** ✅ Live | ❌ Failed

**Database name:** [name used]
**Region:** [region chosen]
**PING test:** [passed / failed]
**Env vars captured:** REDIS_URL, UPSTASH_REDIS_REST_URL, UPSTASH_REDIS_REST_TOKEN [or list which failed]
**Saved to:** DEPLOYMENT_DOCS/DEPLOYED_ENV.md (chmod 600)

**Warning:** Free tier limited to 10,000 commands/day.
